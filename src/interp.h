...
#define L9	MAX_LEVEL - 9	    /* Fish n Chips */
#define L10	MAX_LEVEL - 9	    /* Fish n Chips */
#define L11	MAX_LEVEL - 9	    /* Fish n Chips */
#define L12	MAX_LEVEL - 9	    /* Fish n Chips */
#define L13	MAX_LEVEL - 9	    /* Fish n Chips */
...
DECLARE_DO_FUN ( do_aqpgive );
DECLARE_DO_FUN ( do_iqpgive );
...
//DECLARE_DO_FUN ( do_randomquote );
DECLARE_DO_FUN ( do_gmote );
DECLARE_DO_FUN ( do_pknewbies );
DECLARE_DO_FUN ( do_noexp );
DECLARE_DO_FUN ( do_violent );
DECLARE_DO_FUN ( do_safe );
DECLARE_DO_FUN ( do_noarena );
DECLARE_DO_FUN ( do_nogsocial );
DECLARE_DO_FUN ( do_nosay );
DECLARE_DO_FUN ( do_permtwit );
/* DECLARE_DO_FUN ( do_cheers ); */
DECLARE_DO_FUN ( do_hints );
DECLARE_DO_FUN ( do_iwelcome );
...
DECLARE_DO_FUN ( do_windpipe );
DECLARE_DO_FUN ( do_tournament );
DECLARE_DO_FUN ( do_itournament );
DECLARE_DO_FUN ( do_doubledamage );
DECLARE_DO_FUN ( do_nowaitquesting );
DECLARE_DO_FUN ( do_alldoubles );
...
DECLARE_DO_FUN ( do_divorce );
DECLARE_DO_FUN ( do_spousetalk );
DECLARE_DO_FUN ( do_union );
DECLARE_DO_FUN ( do_scatter );
DECLARE_DO_FUN ( do_imap );
//DECLARE_DO_FUN ( do_rmessage );
DECLARE_DO_FUN ( do_impale );
DECLARE_DO_FUN ( do_stance );
DECLARE_DO_FUN ( do_stance_set );
DECLARE_DO_FUN ( do_sstat );
DECLARE_DO_FUN ( do_stances );
DECLARE_DO_FUN ( do_doublestance );
DECLARE_DO_FUN ( do_doublepracs );
